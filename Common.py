...
def Message(option, back, Language = -1):
    message = {
        ...
        13: ["请输入行数 --- 找到关键字后应该忽略之后的几行; 例如：1代表忽略关键字后的下一行，0代表不忽略", "Please Input # Of Lines --- # of line to ignore after keyword matched; e.g. 1 -> ignore 1(next) line after keyword, 0 -> not ignore any line"][Language],
    }
